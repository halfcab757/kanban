...
const Todos: React.FC = () => {
    ...
    return (
        <TodosContainer>
            <TodoList title='Todos' items={todosCtx.freshTodos}/>
            <TodoList title='In progress' items={todosCtx.progressedTodos}/>
            <TodoList title='Done' items={todosCtx.finishedTodos}/>
        </TodosContainer>
    );
}
